...
#include "DeathRaceOffroadCar.h"
#include "DeathRaceOffroadWheelFront.h"
#include "DeathRaceOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ADeathRaceOffroadCar::ADeathRaceOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeathRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeathRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeathRaceOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeathRaceOffroadWheelRear::StaticClass();
